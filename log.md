...
**Today's Progress**: Javascript Tutorial: Navbar & Sidebar
...
**Today's Progress**: Javascript Tutorial: Modal & Questions (https://www.freecodecamp.org/news/hone-your-javascript-skills-by-building-these-15-projects/)
...
**Today's Progress**: Did not code

**Thoughts** Every day I don't code feels like I'm taking time out of the #100DaysOfCode challenge. However, if the circumstances are unavoidable, that's something I have to accept and try not to beat myself up too much.
...
**Today's Progress**: Eloquent Javascript Exercise - Recursion.
...
### Day 87: August 16, 2020

**Today's Progress**: JavaScript Coding Challenges : Edabit (https://edabit.com) (Level 4 : 370 XP). 

**Thoughts** I did some recursion today, and I think I'm getting the hang of it. Date validation, finding lower case letters and joining them from a string of letters... just to name a few.
